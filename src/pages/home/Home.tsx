    ...
    <div>
      ...
      <div className='flex flex-col justify-center items-center pt-10 md:pt-16 lg:pt-20'>
        ...
        <div className='text-2xl md:text-4xl font-bold font-Doxent rtl:md:text-4xl rtl:font-GeomerricArabic text-center'>
          <div ref={title1Ref} className="mb-2 md:mb-4 bg-gradient-to-r from-green-600 dark:from-orange-500 to-orange-500 dark:to-green-500 bg-clip-text text-transparent py-2">{t("Apple Technology")}</div>
        ...
        {loading ? <AllArticlesSkeleton /> : (
          <>
            ...
            <div className='w-[85%] sm:w-full mx-auto grid grid-cols-12 gap-2 md:gap-4 lg:gap-6 2xl:gap-8 my-10'>
              ...
              {articles.slice(0, 12).map(({ id, cover_image, team_members, created_at, title, summary, view_count }) => (
