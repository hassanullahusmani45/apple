            ...
            <div className="grid grid-cols-3 my-12 animate-pulse">
                {Array.from({ length: 3 }).map((_, index) => (
                    <div key={index} className="flex flex-col justify-center items-center gap-2">
                        ...
                        <div className="h-6 w-[5rem] rounded-xl bg-slate-300 dark:bg-slate-700"></div>
                        <div className="h-6 w-[7rem] md:w-[10rem] rounded-xl bg-slate-300 dark:bg-slate-700"></div>
