        ...
        <div className='transition-all'>
            <div className='flex justify-center items-center bg-slate-200 shadow-md shadow-slate-300 dark:shadow-slate-950 dark:bg-slate-800/90 pt-6 px-4 rounded-2xl shadow-3xl my-4'>
                <div className='text-center'>
                    ...
                    {/* Name and Position */}
                    <Link to={`/author-profile/${id}`} className='block bg-gradient-to-br from-blue-500 to-green-500 text-base px-4 py-2 mt-4 space-y-4 rounded-full hover:rounded-xl transition-all ease-in-out duration-150'>
