...
export default function Header() {
  ...
  return (
    <header className=" fixed inset-0 h-20 rounded-full shadow-md  m-5 bg-slate-200 text-slate-950 shadow-slate-400 dark:bg-slate-800 dark:text-white dark:shadow-slate-950">
